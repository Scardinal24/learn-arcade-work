...
class MyGame(arcade.Window):
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        # this will give the bullet a position: bullet.center_x = x
        # this will give the bullet a position: bullet.center_y = y

        bullet.center_x = self.player_sprite.center_x

        # adding a "+ number" will place the bullet above the player
        bullet.center_y = self.player_sprite.center_y + 30

        # This is to make the bullet move up
        bullet.change_y = BULLET_SPEED

        # to add an agle to the bullet so it shoots up
        bullet.angle = 90
